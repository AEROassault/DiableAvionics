...
import org.diableAvionics.util.GraphicsLibEffects;
import org.magiclib.util.MagicRender;
import java.awt.Color;
import org.lazywizard.lazylib.MathUtils;
import org.lwjgl.util.vector.Vector2f;

public class UhlanFire implements EveryFrameWeaponEffectPlugin {
        ...
        if(!hidden){
            ...
            if(weapon.getChargeLevel()==1 && weapon.getAmmo()<ammo){
                ...
                if(MagicRender.screenCheck(0.1f, weapon.getLocation())){
                    ...
                    if(light){
                        GraphicsLibEffects.CustomRippleDistortion(
                                muzzle,
                                weapon.getShip().getVelocity(),
                                50,
                                2,
