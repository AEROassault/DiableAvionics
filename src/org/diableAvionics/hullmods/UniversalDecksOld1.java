...
public class UniversalDecksOld1 extends BaseHullMod {
    ...
    public String getDescriptionParam(int index, HullSize hullSize) {
        ...
        if (index == 1) {
            return (int) ModPlugin.GANTRY_DEPLETION_PERCENT+txt("%");
        }        
        return null;
    }
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if(ship!=null && ship.getVariant()!=null){
            if( ship.getVariant().getNonBuiltInWings().isEmpty()){
                ...
                //effect applied
                String depletion = String.valueOf((int)(ModPlugin.GANTRY_DEPLETION_PERCENT*ship.getVariant().getNonBuiltInWings().size()));
