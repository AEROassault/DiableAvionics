...
import org.diableAvionics.weapons.VirtuousItanoEffect;
...
public class ItanoMissileAI implements MissileAIPlugin, GuidedMissileAI{
    ...
    public ItanoMissileAI(MissileAPI missile, ShipAPI launchingShip){
        ...
        if (target == null && launch){
            ...
            for(WeaponAPI w : missile.getSource().getAllWeapons()){
                if(w.getSlot().getId().equals("PAULDRON_L")){
                    VirtuousItanoEffect script = (VirtuousItanoEffect)w.getEffectPlugin();
