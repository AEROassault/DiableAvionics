...
import org.diableAvionics.weapons.DeepStrikeEffect;
...
public class DeepStrikeAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public DeepStrikeAI(MissileAPI missile, ShipAPI launchingShip) {
...
//        engine.getFleetManager(-1).setSuppressDeploymentMessages(false);
        ...
        */
        ...
        ((DeepStrikeEffect)missile.getWeapon().getEffectPlugin()).NewDeepStrikePod(dropPod);
